...
Client.prototype = {
    ...
    **/
    ...
    /**
    Base URL for this client, of the form "http://host:port[/path]" where [path] 
    is optional but needed for some 3rd party services.
    ...
    **/
    get baseUrl() {
        return this.options.protocol + '://' +
            ...
            this.host + ':' + this.options.port + this.options.path;
    },
